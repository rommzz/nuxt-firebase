<template>
	<div class="bg-gray-100 shadow-md p-2 rounded-md mb-10">
                        ...
                        <template v-for="(item, index) in items">
                            <div :key="index" class="flex my-2">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="my-1" />
                                    <Button fill-width color="red" label="Hapus" @click="deleteItem(item)">
        ...
        <div id="modal" :class="`${showModal ? '' : 'hidden' } fixed z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4`">
            <div class="relative top-40 mx-auto shadow-lg rounded-md bg-white max-w-md">
                ...
                <!-- Modal body -->
                <div class="max-h-48  p-4">Yakin hapus data {{ deletedItems.data.name == undefined ? '' : deletedItems.data.name}} ?
                </div>

                <!-- Modal footer -->
                <div class="px-4 py-2 border-t border-t-gray-500 flex justify-end items-center space-x-4">
                    <Button color="red" @click="deleteData(deletedItems)">
                        Hapus data
                    </Button>
